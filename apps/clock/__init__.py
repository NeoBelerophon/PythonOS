...
def onStart(s, a):
    ...
    timeText.position[0] = gui.core.getCenteredCoordinates(timeText, application.ui)[0]
    secText.position[0] = gui.core.getCenteredCoordinates(secText, application.ui)[0]
    dateText.position[0] = gui.core.getCenteredCoordinates(dateText, application.ui)[0]
